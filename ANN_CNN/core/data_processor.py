...
class DataLoader():
    ...
    def __init__(self, filename, split, cols):
        ...
        max_tbins       = min(50000, len(dataframe))
        i_split         = int(max_tbins * split)
        self.data_train = dataframe.get(cols).values[:i_split]
        self.data_test  = dataframe.get(cols).values[i_split:max_tbins]
    ...
    def get_test_data(self, seq_len, normalise):
        ...
        Warning: batch method, not generative, make sure have enough memory to
